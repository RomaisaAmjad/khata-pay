...
export default function UserProfile() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="text-center">
          ...
          <Text size="lg" className="text-gray-600">Loading user profile...</Text>
        </div>
      </div>
    );
  }
  ...
  return (
    <div>
      <div className=" p-2 shadow-green-100 shadow-sm flex items-center justify-center">
        <Card className="p-10 shadow-2xl max-w-6xl w-full bg-white">
            ...
            <div className="flex-1 w-full space-y-3">
              ...
              <Stack gap="lg">
                ...
                <Group gap="md">
                  ...
                  <div>
                    <Text size="xs" fw={500} className="text-gray-700">Full Name</Text>
                    <Text size="xs" className="text-gray-900">{user.name}</Text>
                  </div>
                </Group>
                ...
                <Group gap="md">
                  ...
                  <div>
                    <Text size="xs" fw={500} className="text-gray-700">Phone Number</Text>
                    <Text size="xs" className="text-gray-900">{user.phone_number}</Text>
                  </div>
                </Group>
                ...
                <Group gap="md">
                  ...
                  <div>
                    <Text size="xs" fw={500} className="text-gray-700">Member Since</Text>
                    <Text size="xs" className="text-gray-900">{formatDate(user.createdAt)}</Text>
                  </div>
                </Group>
              </Stack>
            </div>
