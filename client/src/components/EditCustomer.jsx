      ...
      <div className="ml-60 bg-white flex flex-col items-center justify-center p-3 rounded-sm shadow-2xl w-80 max-w-sm">
        ...
        <div className="flex justify-end gap-2 mt-6">
          ...
          >
            ...
            {isEditMode ? <span className="text-xs font-light px-2 py-1 flex items-center gap-1  bg-green-700 rounded-xl  hover:bg-green-800 hover:cursor-pointer">Save Changes</span> :<span className="flex bg-blue-900  hover:bg-blue-800  justify-center items-center gap-1 rounded-xl py-1 px-2 text-xs  hover:cursor-pointer">Create Record</span> }
            </span>
          </button>
        </div>
      </div>
