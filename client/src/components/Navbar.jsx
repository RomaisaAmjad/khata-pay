  ...
  return (
    <header className="bg-white shadow-sm px-6 py-4 border-b border-gray-100">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        {/* Logo / Brand */}
        <Link href="/" className="text-[#0a6b1f] text-xl font-bold"
        style={{fontFamily:"Harabara"}}>
          Khata Pay
        </Link>

        {/* Nav Links */}
        {/* <Group gap="lg" className="text-gray-700 font-medium">
          <Link href="/" className="hover:text-[#0a6b1f] transition-colors duration-200">
            Home
          </Link>
          <Link href="/about" className="hover:text-[#0a6b1f] transition-colors duration-200">
            About
          </Link>
          <Link href="/dashboard" className="hover:text-[#0a6b1f] transition-colors duration-200">
            Dashboard
          </Link>
          <Link href="/profile" className="hover:text-[#0a6b1f] transition-colors duration-200">
            Profile
          </Link>
        </Group> */}
